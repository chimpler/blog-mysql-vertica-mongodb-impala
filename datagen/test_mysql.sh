...
echo "SET SQL_BIG_SELECTS=1; SELECT advertiser_id, AVG(clicks) FROM analytics WHERE ymdh BETWEEN '2012-06-01 00:00:00' AND '2012-07-01 00:00:00' GROUP BY advertiser_id" | /usr/bin/time --portability mysql -u $USERNAME -p$PASSWORD -U $DATABASE
echo "SET SQL_BIG_SELECTS=1; SELECT advertiser_id, AVG(clicks) FROM analytics WHERE ymdh BETWEEN '2012-06-01 00:00:00' AND '2012-07-01 00:00:00' GROUP BY advertiser_id" | /usr/bin/time --portability mysql -u $USERNAME -p$PASSWORD -U $DATABASE
